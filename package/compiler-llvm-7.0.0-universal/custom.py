...
def setup(i):
    ...
    if macos=='yes':
       ...
       nie['PACKAGE_NAME']='clang+llvm-7.0.0-x86_64-apple-darwin.tar.xz'
...
#             nie['PACKAGE_NAME']='clang+llvm-7.0.0-x86_64-linux-gnu-debian8.tar.xz'
          else:
             nie['PACKAGE_NAME']='clang+llvm-7.0.0-x86_64-linux-gnu-ubuntu-16.04.tar.xz'

             if mver=='14.04':
                nie['PACKAGE_NAME']='clang+llvm-7.0.0-x86_64-linux-gnu-ubuntu-14.04.tar.xz'
             elif mver=='16.10':
                nie['PACKAGE_NAME']='clang+llvm-7.0.0-x86_64-linux-gnu-ubuntu-16.04.tar.xz'
