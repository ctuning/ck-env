...
def setup(i):
    ...
    if macos=='yes':
       ...
       nie['PACKAGE_NAME']='clang+llvm-9.0.0-x86_64-apple-darwin.tar.xz'
...
#          return {'return':1, 'error':'ARM platform is not supported yet'}
          if hbits=='64':
             nie['PACKAGE_NAME']='clang+llvm-9.0.0-aarch64-linux-gnu.tar.xz'
          else:
             nie['PACKAGE_NAME']='clang+llvm-9.0.0-armv7a-linux-gnueabihf.tar.xz'
       else:
...
#             nie['PACKAGE_NAME']='clang+llvm-9.0.0-x86_64-linux-gnu-debian8.tar.xz'
          else:
             nie['PACKAGE_NAME']='clang+llvm-9.0.0-x86_64-linux-gnu-ubuntu-18.04.tar.xz'

             if mver=='14.04':
                nie['PACKAGE_NAME']='clang+llvm-9.0.0-x86_64-linux-gnu-ubuntu-14.04.tar.xz'
             elif mver=='16.04':
                nie['PACKAGE_NAME']='clang+llvm-9.0.0-x86_64-linux-gnu-ubuntu-16.04.tar.xz'
             elif mver=='16.10':
                nie['PACKAGE_NAME']='clang+llvm-9.0.0-x86_64-linux-gnu-ubuntu-16.04.tar.xz'
             elif mver=='18.04':
                nie['PACKAGE_NAME']='clang+llvm-9.0.0-x86_64-linux-gnu-ubuntu-18.04.tar.xz'
                ...
                nie['PACKAGE_NAME']='clang+llvm-9.0.0-x86_64-linux-gnu-ubuntu-19.04.tar.xz'
