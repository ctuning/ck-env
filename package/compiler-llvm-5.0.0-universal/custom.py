...
def setup(i):
    ...
    if macos=='yes':
       ...
       nie['PACKAGE_NAME']='clang+llvm-5.0.0-x86_64-apple-darwin.tar.xz'
       ...
       if habi.startswith('arm'):
          if hbits=='64':
             ...
             nie['PACKAGE_NAME']='clang+llvm-5.0.0-armv7a-linux-gnueabihf.tar.xz'
       else:
          ...
          if 'debian' in flavor:
             ...
             nie['PACKAGE_NAME']='clang+llvm-5.0.0-x86_64-linux-gnu-ubuntu-16.04.tar.xz'

             if mver=='14.04':
                nie['PACKAGE_NAME']='clang+llvm-5.0.0-x86_64-linux-gnu-ubuntu-14.04.tar.xz'
             elif mver=='16.10':
                nie['PACKAGE_NAME']='clang+llvm-5.0.0-x86_64-linux-gnu-ubuntu-16.10.tar.xz'
