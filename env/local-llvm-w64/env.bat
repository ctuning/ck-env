...
rem Target OS UOA    = windows-64
rem Target OS bits   = 64
rem Tool version     = local
rem Tool int version = 888888

rem Dependencies
call D:\Work1\CK\ck-repos\fgg-local-win\env\417c4f809574a74d\env.bat
...
set CK_BC_EXT=.bc
set CK_CC=clang
set CK_COMPILER_FLAGS_OBLIGATORY= -DWINDOWS -m64
